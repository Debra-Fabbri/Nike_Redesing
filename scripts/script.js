...
const btnNavWoman = document.querySelector('#btnNavWoman');
const btnNavMen = document.querySelector('#btnNavMen');
const btnNavNewSeason = document.querySelector('#btnNavNewSeason');
const btnNavHotSale = document.querySelector('#btnNavHotSale');
...
const btnFooterWoman = document.querySelector('#btnFooterWoman');
const btnFooterMen = document.querySelector('#btnFooterMen');
const btnFooterNewSeason = document.querySelector('#btnFooterNewSeason');
const btnFooterHotSale = document.querySelector('#btnFooterHotSale');
...
btnNavWoman.addEventListener('click',(e)=>{
        e.preventDefault();
        let filter = filterProducts('Woman');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: Woman`;
...
btnNavMen.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('Men');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: Men`;
        productsInformationResults.textContent=`${ filter.length} Resultados`
        scrollTo(0,productsInformation.offsetTop - 50);
        setTimeout(() => {
                loadContainerProducts(filter);
...
btnNavNewSeason.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('New Season');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: New Season`;
        productsInformationResults.textContent=`${ filter.length} Resultados`
        scrollTo(0,productsInformation.offsetTop - 50);
        setTimeout(() => {
                loadContainerProducts(filter);
...
btnNavHotSale.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('Hot Sale');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
                btn__nav.classList.toggle('active');
        }
        productsInformationTitle.textContent=`Categoria: Hot Sale`;
        productsInformationResults.textContent=`${ filter.length} Resultados`
        scrollTo(0,productsInformation.offsetTop - 50);
        setTimeout(() => {
                loadContainerProducts(filter);
...
btnFooterWoman.addEventListener("click",(e)=>{
        e.preventDefault();
        let filter = filterProducts('Woman');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
...
btnFooterMen.addEventListener('click', (e)=>{
        e.preventDefault();
        let filter = filterProducts('Men');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
...
btnFooterNewSeason.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('New Season');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
...
btnFooterHotSale.addEventListener('click', (e) => {
        e.preventDefault();
        let filter = filterProducts('Hot Sale');
        if (nav__menu.classList.contains('show')) {
                nav__menu.classList.toggle('show');
